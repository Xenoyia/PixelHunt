...
public class CaptureListener {
    ...
    public void onPokemonCapture(CaptureEvent.SuccessfulCapture event) {
        ...
        if(event.getPokemon().getName().equalsIgnoreCase(Main.pokemon1)) {
            if(event.getPokemon().getNature().toString().equalsIgnoreCase(Main.nature1)) {
                Sponge.getServer().getBroadcastChannel().send(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7a"+p.getName()+" \u00A7fcaught a \u00A7a/hunt\u00A7f Pok\u00E9mon! "+"\u00A7f(\u00A7a"+event.getPokemon().getNature()+" "+event.getPokemon().getName()+"\u00A7f)"));
                ...
                pl.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fIVs changed from \u00A7a"+oldIVs+" \u00A7fto \u00A7a"+newIVs+"\u00A7f!"));
                ...
                pl.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A76You have been given \u00A7e"+Main.pokemon1moneyReward+" coins\u00A76!"));
                Utils.getInstance().randomisePokemon(1);
                Sponge.getServer().getBroadcastChannel().send(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fNew hunted Pok\u00E9mon is: \u00A7a"+Main.pokemon1));
                ...
                pl.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis one isn't right.. keep hunting!"));
            }
            ...
            if(event.getPokemon().getNature().toString().equalsIgnoreCase(Main.nature2)) {
                ...
                pl.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A76You have been given \u00A7e"+Main.pokemon2moneyReward+" coins\u00A76!"));
                Utils.getInstance().randomisePokemon(2);
                Sponge.getServer().getBroadcastChannel().send(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fNew hunted Pok\u00E9mon is: \u00A7a"+Main.pokemon2));
            ...
            if(event.getPokemon().getNature().toString().equalsIgnoreCase(Main.nature3)) {
                ...
                pl.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A76You have been given \u00A7e"+Main.pokemon3moneyReward+" coins\u00A76!"));
                Utils.getInstance().randomisePokemon(3);
                Sponge.getServer().getBroadcastChannel().send(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fNew hunted Pok\u00E9mon is: \u00A7a"+Main.pokemon3));
            ...
            if(event.getPokemon().getNature().toString().equalsIgnoreCase(Main.nature4)) {
                ...
                pl.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A76You have been given \u00A7e"+Main.pokemon4moneyReward+" coins\u00A76!"));
                Utils.getInstance().randomisePokemon(4);
                Sponge.getServer().getBroadcastChannel().send(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fNew hunted Pok\u00E9mon is: \u00A7a"+Main.pokemon4));
    ...
    public void increaseWildIVs(EntityPixelmon e, Player p) {
        ...
        e.updateStats();
        if(EnumRarePokemon.rarePokemon(e.getName()) || EnumVeryRarePokemon.veryRarePokemon(e.getName())) p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis rare \u00A7a" + e.getName() + "\u00A7f received \u00A7aa 20% increase in IVs\u00A7f!"));
        else p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis \u00A7a" + e.getName() + "\u00A7f received \u00A7aa 10% increase in IVs\u00A7f!"));
    }
    ...
    public void increaseIVs(EntityPixelmon e, Player p) {
        ...
        switch (natureNum)
        {
            case 5:
                ...
                e.updateStats();
                p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis \u00A7a"+e.getName()+"\u00A7f received \u00A7amaxed attack IVs\u00A7f!"));
                break;
            case 6:
                e.stats.IVs.Attack = 31;
                e.updateStats();
            ...
            case 9:
                ...
                e.updateStats();
                p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis \u00A7a"+e.getName()+"\u00A7f received \u00A7amaxed defence IVs\u00A7f!"));
                break;
            case 10:
                e.stats.IVs.Defence = 31;
                e.updateStats();
            ...
            case 13:
                ...
                e.updateStats();
                p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis \u00A7a"+e.getName()+"\u00A7f received \u00A7amaxed speed IVs\u00A7f!"));
                break;
            case 14:
                e.stats.IVs.Speed = 31;
                e.updateStats();
            ...
            case 17:
                ...
                e.updateStats();
                p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis \u00A7a"+e.getName()+"\u00A7f received \u00A7amaxed sp. attack IVs\u00A7f!"));
                break;
            case 18:
                e.stats.IVs.SpAtt = 31;
                e.updateStats();
            ...
            case 21:
                ...
                e.updateStats();
                p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis \u00A7a"+e.getName()+"\u00A7f received \u00A7amaxed sp. defence IVs\u00A7f!"));
                break;
            case 22:
                e.stats.IVs.SpDef = 31;
                e.updateStats();
            ...
            default:
                ...
                if(e.stats.IVs.Speed > 31) e.stats.IVs.Speed = 31;
                e.updateStats();
                if(EnumRarePokemon.rarePokemon(e.getName()) || EnumVeryRarePokemon.veryRarePokemon(e.getName())) p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis rare \u00A7a"+e.getName()+"\u00A7f received \u00A7aa 30% increase in IVs\u00A7f!"));
                else p.sendMessage(Text.of("\u00A78\u00A7o[\u00A7bHunt\u00A78\u00A7o] \u00A7fThis \u00A7a"+e.getName()+"\u00A7f received \u00A7aa 20% increase in IVs\u00A7f!"));
                break;
        }
